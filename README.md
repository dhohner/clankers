...
| [`task-executor`](./plugins/task-executor) | Implements task files for coding agents with TDD and independent requirement verification. | Yes | Yes | No |
...
Install the bundled Pi plugins, `output-styles` and `security-guard`.
