...
class PrdBundleAssetsTests(unittest.TestCase):
    def test_review_assets_cover_responsive_navigation_anchor_and_print_behavior(self) -> None:
        ...
        self.assertIn("nodeSpacing: 90", script)
        self.assertIn("rankSpacing: 120", script)
        self.assertIn('clusterBkg: "transparent"', script)
        self.assertIn('clusterBorder: "transparent"', script)
        ...
        self.assertIn("stroke: transparent !important", styles)
