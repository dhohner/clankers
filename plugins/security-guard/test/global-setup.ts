...
// leaves nothing behind in /tmp. `os.tmpdir()` is avoided for the reason given in temp-dirs.ts: TMPDIR is
// not trusted. Vitest forwards `process.env` set here to its workers.
